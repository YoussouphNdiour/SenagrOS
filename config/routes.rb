Rails.application.routes.draw do
  ...
  namespace :backend do
    ...
    # Redirects for underscore URLs that should use dashes (path: 'cultivable-zones')
    get '/cultivable_zones/new',  to: redirect('/backend/cultivable-zones/new')
    get '/cultivable_zones',      to: redirect('/backend/cultivable-zones')
    get '/cultivable_zones/:id',  to: redirect { |p, _r| "/backend/cultivable-zones/#{p[:id]}" }
