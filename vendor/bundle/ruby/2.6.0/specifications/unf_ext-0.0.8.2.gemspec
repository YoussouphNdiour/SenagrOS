...
Gem::Specification.new do |s|
  ...
  s.files = [".document".freeze, ".github/workflows/unf_ext.yml".freeze, ".gitignore".freeze, "CHANGELOG.md".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "ext/unf_ext/extconf.rb".freeze, "ext/unf_ext/unf.cc".freeze, "ext/unf_ext/unf/normalizer.hh".freeze, "ext/unf_ext/unf/table.hh".freeze, "ext/unf_ext/unf/trie/char_stream.hh".freeze, "ext/unf_ext/unf/trie/node.hh".freeze, "ext/unf_ext/unf/trie/searcher.hh".freeze, "ext/unf_ext/unf/util.hh".freeze, "lib/unf_ext.rb".freeze, "lib/unf_ext/version.rb".freeze, "test/helper.rb".freeze, "test/normalization-test.txt".freeze, "test/test_unf_ext.rb".freeze, "unf_ext.gemspec".freeze]
