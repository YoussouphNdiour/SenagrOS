# -*- encoding: utf-8 -*-
# stub: beardley-groovy 2.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "beardley-groovy".freeze
  s.version = "2.0.1"
  ...
  s.homepage = "http://github.com/burisu/beardley-groovy".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.0.3.1".freeze
  s.summary = "Groovy for Beardley".freeze
