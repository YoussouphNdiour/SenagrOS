...
it('renders animal name', () => {
  render(<AnimalShow animal={animal} interventions={[]} canDestroy={true} />)
...
it('renders décédé badge when dead_at present', () => {
  render(<AnimalShow animal={{ ...animal, dead_at: '2024-01-01T00:00:00Z' }} interventions={[]} canDestroy={true} />)
