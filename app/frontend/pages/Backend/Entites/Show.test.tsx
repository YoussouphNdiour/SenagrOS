...
describe('EntiteShow', () => {
  it('renders entity name', () => {
    render(<EntiteShow entite={mockEntite} />)
  ...
  it('shows Contact badge for contact nature', () => {
    render(<EntiteShow entite={{ ...mockEntite, nature: 'contact', full_name: 'John Doe' }} />)
    expect(screen.getByText('Contact')).toBeInTheDocument()
  })

  it('shows Inactif badge when not active', () => {
    render(<EntiteShow entite={{ ...mockEntite, active: false }} />)
